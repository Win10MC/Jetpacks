...
public class ModItems {
	...
	public static final JetpackItem IRON_JETPACK = new JetpackItem(ModArmorMaterials.IRON_JETPACK_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
			new Settings().maxCount(1).maxDamage(50),
			0.04, 0.06, 0.6, 0.4, false);

	public static final JetpackItem GOLD_JETPACK = new JetpackItem(ModArmorMaterials.GOLD_JETPACK_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
			new Settings().maxCount(1).maxDamage(35),
			0.06, 0.08, 0.6, 0.4, false);

	public static final JetpackItem DIAMOND_JETPACK = new JetpackItem(ModArmorMaterials.DIAMOND_JETPACK_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
			new Settings().maxCount(1).maxDamage(100),
			0.08, 0.12, 0.6, 0.4, true);

	public static final JetpackItem NETHERITE_JETPACK = new JetpackItem(ModArmorMaterials.NETHERITE_JETPACK_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
